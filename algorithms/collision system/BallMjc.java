...
public class BallMjc {
    ...
    public BallMjc(double rx, double ry, double vx, double vy, double radius, double mass, Color color) {
        this.vx = vx;
        this.vy = vy;
        this.rx = rx;
        this.ry = ry;
    ...
    public BallMjc(Double r, Double m) {
        rx     = Math.random();
        ry     = Math.random();
        vx     = 0.01 * (Math.random() - 0.5);
        vy     = 0.01 * (Math.random() - 0.5);
    ...
    public double timeToHit(BallMjc b) {
        BallMjc a = this;
    ...
    public void bounceOff(BallMjc that) {
